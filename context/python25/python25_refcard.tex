...
\CM {\tt s=xrange(1000)}                   \\ immut. xrange-sequence                   \\
...
\CM {\tt while True: ... if cond: break} \\ do... while equivalent \\
...
\stoptyping \\
list comprehension \crlf
with lc-clauses \\

\CM {\tt pass}                           \\ empty statement \\
\CM {\tt def f(params): statements}      \\ function definition \\
\CM {\tt def f(x, y=0): return x+y}      \\ optional parameter \\
\CM {\tt def f(*a1, **a2): statements}   \\ additional list of unnamed, dict of named paramters \\
\CM {\tt def f(): f.variable = 1 ...}    \\ function attribute \\
\CM {\tt return expression}              \\ return from function \\
\CM {\tt yield expression}               \\ make function a generator \\
