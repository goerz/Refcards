...
\cm{call IMAP('\bt{}w', '\bs{}omega', 'tex')}{override macro}
\cm{\dots\bs\lt{}CR\gt{}\dots}{newline in macro}
\cm{set g:Imap\_FreezeImap=1}{pause macro extension}
...
\cm{\bt{}$,$  }
   {\tt\bs{}nonumber}
\cm{\bt{}\tild{}  }
   {\bs{}tilde\brplaceholder{}\placeholder{}}
\cm{\bt{};{}  }
...
\cmlong{:set g:Tex\_CompileRule\_\lt{}fmt\gt{} = '\dots'\enter}{set compilation rule (\tt{}fmt\rm{} is \tt{}dvi\rm{}, \tt{}pdf\rm{}, etc.)}
\cmlong{:let g:Tex\_FormatDependency\_pdf = 'dvi,pdf'\enter}{define dependency}
