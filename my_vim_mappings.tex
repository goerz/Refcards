...
\vskip 0.4cm
(CC) 2009 Michael Goerz ({\tt www.michaelgoerz.net})
\vskip -0.2cm
...
\cm{}{:ApppendSnippets}{Append snippet below line}
\cm{}{:InsertSnippets}{Insert snippet before line}
...
\dcm{n:}{\leader{}f}{v:}{\ileader f}{{Filter entire file}}
...
\section{\TeX}
\cm{}{:LatexFold}{Fold up LaTeX (fmt=manual)}
\dcm{n,v:}{\leader e}{i:}{\ileader e}{wrap in {\tt \bs{}emph}}
\dcm{n,v:}{\leader o}{i:}{\ileader o}{wrap in {\tt \bs{}op}}
...
\cm{}{:FortranFold}{Fold up Fortran code (fmt=manual)}

\vskip 0.1cm
\section{Python}
\cm{n:}{\leader{}pw \or \leader\bs{}pW}{View Python reference for keyword}
