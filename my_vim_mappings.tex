...
\vskip 0.4cm
(CC) 2010 Michael Goerz ({\tt www.michaelgoerz.net})
\vskip -0.2cm
...
\dcm{n,v:}{\leader e}{i:}{\ileader e}{insert or wrap in {\tt \bs{}emph}}
\dcm{n,v:}{\leader o}{i:}{\ileader o}{insert or wrap in {\tt \bs{}op}}
\cm{i:}{\ileader k}{insert {\tt \bs{}ket}}
\dcm{n:}{\leader i}{i:}{\ileader i}{insert environment or math function}
\cm{i:}{\ileader e}{{\tt \bs{}text}}
...
{\smallrm This work is licensed under the Creative Commons
  ...
  (CC) {\oldstyle 2010} by Michael Goerz.
% Ending
\supereject
\if L\lr \else\null\vfill\eject\fi
\if L\lr \else\null\vfill\eject\fi
