...
\cm{:next :prev :first :last}{move between buffers}
\cm{:wn :wN}{write buffer and edit next, previous one}
...
\sect{Spell checking}
\cm{:set spell spelllang=en\_us\enter}{activate spellcheck}
...
\cm{K}{run keywordprg (man) on word under cursor}
