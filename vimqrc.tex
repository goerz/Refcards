...
\sect{Advanced insertion/formatting}
...
\sect{Buffers}
\cm{:tab ball\enter}{show buffer tablist}
\cm{:buffers\enter}{show list of buffers}
\cm{:buffer n\enter}{switch to buffer n}
\cm{:badd f.txt\enter}{load file into new buffer}
\cm{:bdelete n\enter}{delete buffer n (also with filename)}
...
\sect{Spell checking}
\cm{:setlocal spell spelllang=en\_us\enter}{activate}
